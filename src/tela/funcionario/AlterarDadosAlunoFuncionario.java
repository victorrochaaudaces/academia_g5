...
public class AlterarDadosAlunoFuncionario extends javax.swing.JFrame {
     ...
     */
    public AlterarDadosAlunoFuncionario() {
        initComponents();
    ...
    public AlterarDadosAlunoFuncionario(User user) {
        initComponents();
        this.user = user;
...
//        user = new User();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarDadosAlunoFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarDadosAlunoFuncionario().setVisible(true);
            }
        });
    }
